...
[0] = LAYOUT(
  ...
  KC_TAB,   KC_A,   KC_S,    KC_D,    KC_F,    KC_F,                     KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN,  KC_QUOT,
...
[2] = LAYOUT(
  ...
  _______,   KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PERC,                      KC_DLR , KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PIPE,
  _______,   KC_EQL,  KC_MINS, KC_PLUS, KC_HASH, KC_CIRC, _______,    _______, KC_LBRC, KC_RBRC, KC_SCLN, KC_COLN, KC_BSLS, _______,
